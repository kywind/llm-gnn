...
class ParticleDataset(Dataset):
    def __init__(self, data_dir, args, phase, cam):
        ...
        n_episode = 2000  # config['dataset']['n_episode']
        n_timestep = 10  # config['dataset']['n_timestep']
        self.global_scale = 24  # config['dataset']['global_scale']

        train_valid_ratio = 0.9  # config['train']['train_valid_ratio']
        ...
        self.n_his = args.n_his  # config['train']['n_history']
        self.n_roll = args.n_rollout  # config['train']['n_rollout']
